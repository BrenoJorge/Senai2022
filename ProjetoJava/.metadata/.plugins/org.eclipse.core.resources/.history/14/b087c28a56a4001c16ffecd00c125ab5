				...
				for (int i = 0; i < alunos.length; i++) {
					if (alunos[i] != null) {
						if (alunos[i].ra == raa) {
							...
							System.out.println(
									"Nome do aluno " + new SimpleDateFormat("dd/MM/yyyy").format(alunos[i].nascimento));
							System.out.println("Nome do aluno " + alunos[i].calcIdade());
							System.out.println("Situacao do aluno " + alunos[i].obterConceito());
							System.out.println("");
						}
					}
				}
