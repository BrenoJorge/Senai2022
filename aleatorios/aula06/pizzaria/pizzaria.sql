...
select * from where nome = "Cesar Augusto Pascali Rago";
delete from telefone where cliente_id = 12;
...
ADD cpf varchar(11) after Cliente_id;

alter table Clientes
modify column cpf varchar(11) first;

alter table Clientes
modify column cpf varchar(11) after Cliente_id;

ALTER TABLE Clientes
DROP COLUMN cpf;

select nome from clientes into outfile 'C:/Users/Aluno/Desktop/aula06/pizzaria/nome.txt';
